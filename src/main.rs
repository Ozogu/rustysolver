...
impl CFR {
    ...
    fn get_strategy(&mut self, info_set: &str, realization_weight: f64) -> Vec<f64> {
    ...
    fn cfr(&mut self, state: &GameState, player: usize, p0: f64, p1: f64, depth: usize) -> f64 {
    ...
    fn get_average_strategy(&self, info_set: &str) -> Vec<f64> {
